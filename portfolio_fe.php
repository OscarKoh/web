...
<br>
    <body>
        <div class="row mx-auto px-5">
            <div class="col-md-6 pt-4 py-2">
                <h1>ARTWORK TITLE</h1>
                <p>Artwork Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                <br>
                <br>
            </div>
            <div class="col-md-6 pt-4 py-2">
                <img src="image/explore/caroucel/BIRD.png" class="w-75">
            </div>
        </div>
        <div class="row mx-auto pt-4 py-2 px-5">
            <div>
               <h6>Done by</h6>
                <p>Nur Nazimah Binti Hamizan, Ainul Raihanah Binti Mohamand Asri, Muhammad Zahirul Bin Abd Halim</p>
            </div>
        </div>
        <div class="row mx-auto pt-4 py-2 px-5">
                <form action="" method="post">
                    <label for="my name">Name</label>
                    <input type="text" name="my name" id="" class="form-control" placeholder="Put Your Name Here">
                    <br>

                    <label for="my email">Comment</label>
                    <input type="text" email="my email" id="" class="form-control" placeholder="Put Your Comment Here">
                    <br>
