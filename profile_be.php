            ...
            <div class="col-md-8 bg-white">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="specialize">Specialize in which area?:</label>
                        <textarea class="form-control" rows="1" id="specialize" name="specialize" placeholder="3D or 2D..."></textarea>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="description">Description:</label>
                        <textarea class="form-control" rows="5" id="description" name="description" placeholder="Fill in your personal description here"></textarea>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="social_media1">Social Media :</label>
                        <textarea class="form-control" rows="1" id="social_media" name="social_media" placeholder="Put your link here"></textarea>
                        <br>
                    </div>
                    <div class="form-group">
                        <label for="user_picture">Upload your picture:</label>
