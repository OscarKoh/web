...
<body>
	...
	<div class="catpage-filter-margin" style="">
		...
		<div class="normcat-filter-content-container">
			...
			<section class="cat-image-gallery">
				<div>
					<?php 
        // Set the category_id for Visual Communication
        $category_id = 'Visual Communication'; // Directly set the category_id to Visual Communication
