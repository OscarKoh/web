...
// 添加数据库连接
$conn = new mysqli("localhost", "user_id", "user_password", "database_name");
...
<body>
    ...
    <div class="container">
        <div class="note-box">
            ...
            <ul>
                <li>A minimum of 1 alphabet</li>
                <li>A minimum of 1 numeric character [0-9]</li>
                <li>A minimum of 1 special character (symbol)</li>
            </ul>
            <p>2. Change password whenever necessary.</p>
            <p>3. You are responsible for keeping the password safe.</p>
    ...
    <div class="form-wrapper">
        <form action="" method="POST">
            ...
            <div style="text-align: center; margin-bottom: 10px; padding: 5px; <?php echo $message_style; ?>"> <?php echo $message;?>
            </div>
            <?php endif; ?>
            <div class="form-row">
